...
CREATE INDEX arg_ballo_localizaciones_ix_agrupado ON arg_pv_localizaciones USING btree(id_agrupado);
CREATE INDEX arg_ballo_loc_telegramas_ix_agrupado ON arg_pv_loc_telegramas USING btree(id_agrupado);
CREATE INDEX arg_ballo_localizaciones_ix_nombre ON arg_pv_localizaciones USING btree(id_agrupado);